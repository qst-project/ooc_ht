...
function BuildingInfo() {
    return (
        <section className={styles.main}>
            ...
            <p className={styles.descr}>Добро пожаловать на наш сайт недвижимости! Мы предлагаем широкий выбор жилой и коммерческой недвижимости в различных районах города. Наша команда профессиональных агентов готова помочь вам в выборе и покупке или аренде недвижимости, которая соответствует вашим потребностям и бюджету.</p>
            <TaskList
